...
(function() {
    ...
    var _score = function(entryResults) {
        ...
        entryResults.forEach(function(fieldResults) {
            fieldResults.patterns.forEach(function(pattern) {
                if (patternsMinInsertions[pattern.value] === undefined || pattern.insertions < patternsMinInsertions[pattern.value]) {
    ...
    var _search = function(entries, patterns, fields, options) {
        ...
        entries.forEach(function(entry) {
            ...
            if ((options.fieldMatching === true && match === true) || (options.fieldMatching === false && entryMatch.length === patterns.length)) {
                results.push({
                    entry: entry,
                    info: entryResults,
    ...
    if (typeof exports !== 'undefined') {
        ...
        angular.module('ngSmartSearch', []).filter('smartSearch', function() {
            return smartSearch;
        });
    } else {
